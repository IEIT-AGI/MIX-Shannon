...
class FCTRModule(LightningModule):
    """
    ...
    def build_model(self) -> nn.Sequential:
        ...
        decoder.exp_cor_task.decoder.token_pos_eb = decoder.rationale_task.decoder.token_pos_eb = encoder.token_pos_eb
        decoder.exp_cor_task.decoder.word_embeddings = decoder.rationale_task.decoder.word_embeddings
