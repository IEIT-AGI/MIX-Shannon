...
class CIDEr:  # todo  CIDEr vs CiderScorer
    def __init__(self, n: Optional[int] = 4, sigma: Optional[float] = 6.0, score_mode: Optional[str] = "max"):
        self._n = n
        self._sigma = sigma
    ...
    def __call__(self, info_dict, pred_name, targets_name):
        return self.compute_score(info_dict, pred_name, targets_name)
