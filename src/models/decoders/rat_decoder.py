...
def build_rat_decoder(d_model=512, nhead=8, num_encoder_layers=6, dim_feedforward=2048, dropout=0.1, activation="relu",
    ...
    return RatDecoder(d_model, encoder_layer, num_encoder_layers, tokenizer, word_embeddings, token_pos_eb)
