...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls):
        tokenizer = BertTokenizer.from_pretrained(
            os.path.join(os.path.expanduser('~'), ".cache/huggingface/transformers/bert-base-uncased"))
    ...
    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2):
        ...
        Qformer = BertLMHeadModel.from_pretrained(os.path.join(os.path.expanduser('~'), ".cache/huggingface/transformers/bert-base-uncased"),
